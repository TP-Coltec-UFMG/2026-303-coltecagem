...
var face_awake: Texture = \
		preload("res://minigames/bother/images/faces/awake.png")
var face_angry: Texture = \
		preload("res://minigames/bother/images/faces/angry.png")
...
@onready var critter: Sprite2D = $Cat
# The critter's face
@onready var face: Sprite2D = $Cat/Face
