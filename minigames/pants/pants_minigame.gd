...
var _pants_sprites = [
	preload( "res://minigames/pants/images/pants/jeans.png" ),
	preload( "res://minigames/pants/images/pants/jeans_shorts.png" ),
	preload( "res://minigames/pants/images/pants/cargo_pants.png" ),
	preload( "res://minigames/pants/images/pants/cargo_shorts.png" ),
	preload( "res://minigames/pants/images/pants/dress_pants.png" ),
	preload( "res://minigames/pants/images/pants/camo_pants.png" ),
	preload( "res://minigames/pants/images/pants/clown_pants.png" ),
	preload( "res://minigames/pants/images/pants/kilt.png" ),
	# Comma on last line intentional for efficient diff files.
]

# A template for random pants.
var pants_template = preload( "res://minigames/pants/scenes/pants/pants.tscn" )
...
func _spawn_pants():
	var pants = pants_template.instantiate()

	# Get a random spawn position.
	$PantsPath/PantsSpawnPoint.progress_ratio += randf_range( 0.25, 1.5 )
	...
	var error = pants.collided.connect( _on_pants_collide )
	if error != OK:
